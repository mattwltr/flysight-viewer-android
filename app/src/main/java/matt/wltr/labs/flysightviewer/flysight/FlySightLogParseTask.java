...
public class FlySightLogParseTask extends AsyncTask<InputStream, Integer, FlySightLog> {
    ...
    private FlySightLogParserObserver flySightLogParserObserver;

    public FlySightLogParseTask(FlySightLogParserObserver flySightLogParserObserver) {
        this.flySightLogParserObserver = flySightLogParserObserver;
    }
    ...
    protected FlySightLog doInBackground(InputStream... inputStreams) {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(inputStreams[0]))) {
    ...
    private Map<FlySightDataType, Integer> getColumnMapping(String headline) {
    ...
    protected void onPostExecute(FlySightLog flySightLog) {
        flySightLogParserObserver.onFlySightLogParsed(flySightLog);
    }
}
